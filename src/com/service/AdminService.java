...
public class AdminService {
	 ...
	 * @return
	 */
	public boolean checkUser(String username, String password,Integer role){
		//return adminDao.getByUsernameAndPasswordAndRole(username, SafeUtil.encode(password),role) != null;
		  Admins admin=adminDao.getByUsernameAndPasswordAndRole(username, SafeUtil.encode(password),role);
